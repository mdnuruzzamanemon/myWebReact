...
import bootstrap from "../images/skillsLogo/bootstrap.png";
      ...
      <div className="skillMainBox">
        ...
        <div className="carousel">
          ...
          <div className="skills-nav-buttons">
            <button style={shadowLeft} onClick={handlePrev}><FontAwesomeIcon icon={faCaretLeft} /></button>
            <button style={shadowRight} onClick={handleNext}><FontAwesomeIcon icon={faCaretRight} /></button>
          </div>

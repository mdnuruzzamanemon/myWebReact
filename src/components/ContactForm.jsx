...
const ContactForm = () => {
  ...
  const THANK_YOU_TEMPLATE_ID = process.env.REACT_APP_EMAILJS_THANK_YOU_TEMPLATE_ID;
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(SERVICE_ID, TEMPLATE_ID, {
      ...
      .then(() => {
        ...
        return emailjs.send(SERVICE_ID, THANK_YOU_TEMPLATE_ID, {
          name,
          email, // user's email
          message: `Thank you, ${name}, for reaching out! Your message has been received and I will get back to you as soon as possible. Have a wonderful day!`,
        }, USER_ID);
      })
      .then(() => {
        setSending(false);
  ...
  return (
    <>
      ...
      <div className="contact-container">
        ...
        {success && <div className="contact-success" style={{ position: 'absolute', bottom: 10, left: 0, right: 0, textAlign: 'center' }}>{success}</div>}
      </div>
    </>
  );
};
